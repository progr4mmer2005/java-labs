...
П.7 = 1 — при обновлении размер текста УВЕЛИЧИВАЕТСЯ до максимума, затем надпись «дальнейшее увеличение невозможно» (вне таблицы)
П.8 = 1 — сброс размера текста через параметр URL до указанного значения (параметр reset=N, где N — уровень от 1 до 6)
П.9 = 1 — ФИО и номер группы выводятся НА СТРАНИЦЕ (не в заголовке вкладки)
П.11 = 1 — порт Tomcat изменён на произвольный;
П.10 = функция из ЛР1: сортировка последовательности чисел по возрастанию.
